...
class ProductionResultScreen extends ConsumerWidget {
  final String? resultId;

  const ProductionResultScreen({
    super.key,
    this.resultId,
  });
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final result = state.productionHistory.firstWhere(
      (r) => r.id == resultId,
      orElse: () => state.productionHistory.first,
    );

    if (resultId == null || !state.productionHistory.any((r) => r.id == resultId)) {
      return Scaffold(
